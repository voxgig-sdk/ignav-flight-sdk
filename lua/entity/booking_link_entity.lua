...
local BookingLinkEntity = {}
BookingLinkEntity.__index = BookingLinkEntity


function BookingLinkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BookingLinkEntity)
  self._name = "booking_link"
  self._client = client
...
function BookingLinkEntity:get_name()
  return self._name
end


function BookingLinkEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BookingLinkEntity.new(self._client, opts)
end
...
function BookingLinkEntity:mark_deleted()
  self._deleted = true
end


function BookingLinkEntity:deleted()
  return true == self._deleted
end


function BookingLinkEntity:data_set(args)
  if args ~= nil then
...
function BookingLinkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BookingLinkEntity:match_set(args)
  if args ~= nil then
...
function BookingLinkEntity:match_get()
...
function BookingLinkEntity:stream(action, args, callopts)
...
---@param reqdata BookingLinkCreateData
---@param ctrl? table
---@return BookingLink
---@return string? err
function BookingLinkEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BookingLinkEntity:_run_op(ctx, post_done)
  local utility = self._utility

...
describe("AirportDirect", function()
  it("should direct-list-airport", function()
    local setup = airport_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-airport", setup.live and "live" or "unit")
...
function airport_direct_setup(mockres)

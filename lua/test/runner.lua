...
function runner.env_override(m)
  local live = runner.getenv("IGNAV_FLIGHT_TEST_LIVE")
  local override = runner.getenv("IGNAV_FLIGHT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IGNAV_FLIGHT_TEST_EXPLAIN")

...
function runner.env_override(m)
  local live = runner.getenv("IGNAVFLIGHT_TEST_LIVE")
  local override = runner.getenv("IGNAVFLIGHT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IGNAVFLIGHT_TEST_EXPLAIN")

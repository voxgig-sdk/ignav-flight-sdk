...
local SDK_MODULE = "ignav-flight_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["airport"] = { ["test01"] = { id = "test01" } }, ["booking_link"] = { ["test01"] = { id = "test01" } }, ["fare_search_model"] = { ["test01"] = { id = "test01" } }, ["fare_search_response_model"] = { ["test01"] = { id = "test01" } } } }'

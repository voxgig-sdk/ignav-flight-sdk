# IgnavFlight SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IgnavFlightSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IgnavFlightSDK(...) and IgnavFlightSDK.test(...) become
#      IgnavFlightSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ignavflight_sdk"
_SDK_CLASS = "IgnavFlightSDK"
...
_ENTITIES = {
    ...
    "FareSearchModel": "fare_search_model",
    "FareSearchResponseModel": "fare_search_response_model",
}

...
class IgnavFlightTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IgnavFlightTestRunner.getenv("IGNAVFLIGHT_TEST_LIVE")
        override = IgnavFlightTestRunner.getenv("IGNAVFLIGHT_TEST_OVERRIDE")
        ...
        explain = IgnavFlightTestRunner.getenv("IGNAVFLIGHT_TEST_EXPLAIN")

...
from ignavflight_sdk.ignavflight_types import (
...
class FareSearchResponseModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FareSearchResponseModelEntity(self._client, opts)
    ...
    def data_get(self) -> FareSearchResponseModel:
    ...
    def match_get(self) -> FareSearchResponseModel:
    ...
    def create(self, reqdata: FareSearchResponseModelCreateData, ctrl=None) -> FareSearchResponseModel:
        utility = self._utility

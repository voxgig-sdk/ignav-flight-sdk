...
class FareSearchModelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FareSearchModelEntity(self._client, opts)
    ...
    def data_get(self) -> FareSearchModel:
    ...
    def match_get(self) -> FareSearchModel:
    ...
    def create(self, reqdata: FareSearchModelCreateData, ctrl=None) -> FareSearchModel:
        utility = self._utility

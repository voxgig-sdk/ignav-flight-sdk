...
class BookingLinkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BookingLinkEntity(self._client, opts)
    ...
    def match_get(self) -> BookingLink:
    ...
    def create(self, reqdata: BookingLinkCreateData, ctrl=None) -> BookingLink:
        utility = self._utility

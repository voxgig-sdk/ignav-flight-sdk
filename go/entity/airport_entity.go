...
func NewAirportEntity(client *core.IgnavFlightSDK, entopts map[string]any) *AirportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AirportEntity) GetName() string { return e.name }
...
func (e *AirportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AirportEntity) Deleted() bool {
	return e.deleted
}


func (e *AirportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAirportEntity(e.client, opts)
}

func (e *AirportEntity) Data(args ...any) any {
...
func (e *AirportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AirportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AirportEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AirportEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *AirportEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AirportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AirportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AirportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

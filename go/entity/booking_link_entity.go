...
func NewBookingLinkEntity(client *core.IgnavFlightSDK, entopts map[string]any) *BookingLinkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BookingLinkEntity) GetName() string { return e.name }
...
func (e *BookingLinkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BookingLinkEntity) Deleted() bool {
	return e.deleted
}


func (e *BookingLinkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBookingLinkEntity(e.client, opts)
}

func (e *BookingLinkEntity) Data(args ...any) any {
...
func (e *BookingLinkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BookingLink; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BookingLinkEntity) DataTyped(data ...BookingLink) BookingLink {
	if len(data) > 0 {
		return typedFrom[BookingLink](e.Data(asMap(data[0])))
	}
	return typedFrom[BookingLink](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BookingLink (all fields
// optional at the wire level).
func (e *BookingLinkEntity) MatchTyped(match ...BookingLink) BookingLink {
	if len(match) > 0 {
		return typedFrom[BookingLink](e.Match(asMap(match[0])))
	}
	return typedFrom[BookingLink](e.Match())
}
...
func (e *BookingLinkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BookingLinkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BookingLinkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BookingLinkEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BookingLinkCreateData and returns an BookingLink. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BookingLinkEntity) CreateTyped(reqdata BookingLinkCreateData, ctrl map[string]any) (BookingLink, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BookingLink{}, err
	}
	return typedFrom[BookingLink](res), nil
}



func (e *BookingLinkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BookingLinkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BookingLinkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

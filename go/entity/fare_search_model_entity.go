...
type FareSearchModelEntity struct {
	name    string
...
func NewFareSearchModelEntity(client *core.IgnavFlightSDK, entopts map[string]any) *FareSearchModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FareSearchModelEntity) GetName() string { return e.name }
...
func (e *FareSearchModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FareSearchModelEntity) Deleted() bool {
	return e.deleted
}


func (e *FareSearchModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFareSearchModelEntity(e.client, opts)
}

func (e *FareSearchModelEntity) Data(args ...any) any {
...
func (e *FareSearchModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FareSearchModel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FareSearchModelEntity) DataTyped(data ...FareSearchModel) FareSearchModel {
	if len(data) > 0 {
		return typedFrom[FareSearchModel](e.Data(asMap(data[0])))
	}
	return typedFrom[FareSearchModel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FareSearchModel (all fields
// optional at the wire level).
func (e *FareSearchModelEntity) MatchTyped(match ...FareSearchModel) FareSearchModel {
	if len(match) > 0 {
		return typedFrom[FareSearchModel](e.Match(asMap(match[0])))
	}
	return typedFrom[FareSearchModel](e.Match())
}
...
func (e *FareSearchModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FareSearchModelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FareSearchModelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FareSearchModelEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FareSearchModelCreateData and returns an FareSearchModel. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FareSearchModelEntity) CreateTyped(reqdata FareSearchModelCreateData, ctrl map[string]any) (FareSearchModel, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return FareSearchModel{}, err
	}
	return typedFrom[FareSearchModel](res), nil
}



func (e *FareSearchModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FareSearchModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FareSearchModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
const testSeed = `map[string]any{"entity": map[string]any{"airport": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "booking_link": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fare_search_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fare_search_response_model": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

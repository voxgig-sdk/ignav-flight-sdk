...
func registerSDKWords(r *eng.Registry, client *sdk.IgnavFlightSDK) {
...
func runOp(client *sdk.IgnavFlightSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

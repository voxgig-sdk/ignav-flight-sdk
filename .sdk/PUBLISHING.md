...
|---|---|---|
| `ts/` | @voxgig-sdk/ignav-flight-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ignav-flight-sdk \
      --repository voxgig-sdk/ignav-flight-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ignav-flight-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ignav-flight-sdk --id=<id>` removes it.

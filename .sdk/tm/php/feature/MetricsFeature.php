...
// IgnavFlight SDK metrics feature
...
class IgnavFlightMetricsFeature extends IgnavFlightBaseFeature
{
    ...
    private function _record(IgnavFlightContext $ctx, bool $ok): void
    {

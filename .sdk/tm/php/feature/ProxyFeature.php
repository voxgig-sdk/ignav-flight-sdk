...
class IgnavFlightProxyFeature extends IgnavFlightBaseFeature
{
    ...
    public function init(IgnavFlightContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IgnavFlightContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

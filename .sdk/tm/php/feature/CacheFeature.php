...
class IgnavFlightCacheFeature extends IgnavFlightBaseFeature
{
    ...
    private function _through(IgnavFlightContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

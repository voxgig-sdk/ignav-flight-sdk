...
// IgnavFlight SDK streaming feature
...
class IgnavFlightStreamingFeature extends IgnavFlightBaseFeature
{
    ...
    private function _iterate(IgnavFlightResult $result): \Generator
    {
    ...
    private function _streamable(IgnavFlightContext $ctx): bool
    {

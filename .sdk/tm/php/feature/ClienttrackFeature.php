...
// IgnavFlight SDK clienttrack feature
...
class IgnavFlightClienttrackFeature extends IgnavFlightBaseFeature
{
    ...
    public function PostConstruct(IgnavFlightContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IgnavFlight-SDK';

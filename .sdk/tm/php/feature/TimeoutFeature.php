...
// IgnavFlight SDK timeout feature
...
class IgnavFlightTimeoutFeature extends IgnavFlightBaseFeature
{
    ...
    private function _with_timeout(IgnavFlightContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IgnavFlightContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
// IgnavFlight SDK utility: fetcher

class IgnavFlightFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IgnavFlightSDK/1.0)';
    ...
    public static function call(IgnavFlightContext $ctx, string $fullurl, array $fetchdef): array
    {

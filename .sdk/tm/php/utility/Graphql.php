...
// IgnavFlight SDK utility: graphql
//
...
class IgnavFlightGraphql
{
    ...
    // equivalent.
    public static function body(IgnavFlightContext $ctx): mixed
    {
    ...
    public static function errors(IgnavFlightContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

...
from projectname_sdk.core.control import IgnavFlightControl
...
class IgnavFlightContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, IgnavFlightSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IgnavFlightResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IgnavFlightResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IgnavFlightError(code, msg, self)

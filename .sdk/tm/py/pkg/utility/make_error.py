# IgnavFlight SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, IgnavFlightError):
        errmsg = err.msg
    ...
    msg = "IgnavFlightSDK: " + opname + ": " + errmsg
    ...
    sdk_err = IgnavFlightError("", msg, ctx)

...
(0, node_test_1.describe)('FareSearchResponseModelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'fare_search_response_model.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != fare_search_response_model_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/fare_search_response_model/FareSearchResponseModelTestData.json');
    ...
    let idmap = transform(['fare_search_response_model01', 'fare_search_response_model02', 'fare_search_response_model03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FareSearchResponseModelEntity.test.js.map
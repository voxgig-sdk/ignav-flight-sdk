...
(0, node_test_1.describe)('AirportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IgnavFlightSDK({
    ...
    (0, node_test_1.test)('direct-list-airport', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-airport', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IGNAV_FLIGHT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IgnavFlightSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IGNAV_FLIGHT_APIKEY,
        }));
        let idmap = env['IGNAV_FLIGHT_TEST_AIRPORT_ENTID'];
    ...
    const client = new __1.IgnavFlightSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AirportDirect.test.js.map
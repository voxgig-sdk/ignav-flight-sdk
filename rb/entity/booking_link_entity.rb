...
class BookingLinkEntity
  ...
  def make
    opts = @_entopts.dup
    BookingLinkEntity.new(@_client, opts)
  end
  ...
  # @return [BookingLink, Hash] the current BookingLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BookingLink fields)
  def match_get
  ...
  #
  # @param reqdata [BookingLinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BookingLink, Hash] the created BookingLink; raises IgnavFlightError on failure

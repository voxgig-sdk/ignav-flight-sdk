...
class AirportEntity
  ...
  def make
    opts = @_entopts.dup
    AirportEntity.new(@_client, opts)
  end
  ...
  # @return [Airport, Hash] the current Airport data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Airport fields)
  def match_get
  ...
  #
  # @param reqmatch [AirportListMatch, Hash, nil] match filter (any subset of
  #   Airport fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Airport>, Array] the matching Airport items; raises IgnavFlightError on failure

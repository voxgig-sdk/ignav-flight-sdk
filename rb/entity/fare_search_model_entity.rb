...
class FareSearchModelEntity
  ...
  def make
    opts = @_entopts.dup
    FareSearchModelEntity.new(@_client, opts)
  end
  ...
  # @return [FareSearchModel, Hash] the current FareSearchModel data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FareSearchModel fields)
  def match_get
  ...
  #
  # @param reqdata [FareSearchModelCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [FareSearchModel, Hash] the created FareSearchModel; raises IgnavFlightError on failure

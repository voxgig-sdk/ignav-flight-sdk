# IgnavFlight Ruby SDK



The Ruby SDK for the IgnavFlight API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `IgnavFlightError` (a `StandardError` subclass), so wrap
...
| `destination` | `Object` |  |
| `ignav_id` | `String` |  |
| `inbound_carrier_code` | `Object` |  |
| `inbound_flight_number` | `Integer` |  |
| `infants_in_seat` | `Object` |  |
| `infants_on_lap` | `Object` |  |
| `market` | `Object` |  |
| `origin` | `Object` |  |
| `outbound_carrier_code` | `Object` |  |
| `outbound_flight_number` | `Integer` |  |
| `return_date` | `Object` |  |
...
```
rb/
├── IgnavFlight_sdk.rb       -- Main SDK module

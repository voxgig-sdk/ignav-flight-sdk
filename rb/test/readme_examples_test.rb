...
#      offline in seeded test mode (IgnavFlightSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IgnavFlight_sdk.rb")
  SDK_CLASS = "IgnavFlightSDK"

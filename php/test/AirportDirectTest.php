...
class AirportDirectTest extends TestCase
{
    public function test_direct_list_airport(): void
    {
        $setup = airport_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-airport", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

...
{
    private static function utility(): IgnavFlightUtility
    {
        return new IgnavFlightUtility();
    }
    ...
    private static function ctx(array $over = []): IgnavFlightContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IgnavFlightContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IgnavFlightOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IgnavFlightError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IgnavFlightOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IgnavFlightMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IgnavFlightOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IgnavFlightMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IgnavFlightOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IgnavFlightMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IgnavFlightSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IgnavFlightMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IgnavFlightResponse([]),
            'result' => new IgnavFlightResult([]),
        ]);
        [, $err] = IgnavFlightMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IgnavFlightSpec([]),
            'response' => null,
            'result' => new IgnavFlightResult([]),
        ]);
        [, $err] = IgnavFlightMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IgnavFlightSpec(['step' => 's']),
            'response' => new IgnavFlightResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IgnavFlightResult([]),
        ]);
        [, $err] = IgnavFlightMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IgnavFlightSpec(['step' => 's']),
            'response' => new IgnavFlightResponse(self::resp(200, ['v' => 1])),
            'result' => new IgnavFlightResult([]),
        ]);
        [, $err] = IgnavFlightMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IgnavFlightSpec(['step' => 's']),
            'response' => new IgnavFlightResponse(self::resp(200, ['v' => 2])),
            'result' => new IgnavFlightResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IgnavFlightMakeResponse::call($ctx);
    ...
    {
        $preset = new IgnavFlightResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IgnavFlightSpec([]),
            'response' => new IgnavFlightResponse([]),
            'result' => new IgnavFlightResult([]),
        ...
        [$got, $err] = IgnavFlightMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IgnavFlightResult([])]);
        [, $err] = IgnavFlightMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IgnavFlightSpec([]), 'result' => null]);
        [, $err] = IgnavFlightMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IgnavFlightSpec(['step' => 's']),
            'result' => new IgnavFlightResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IgnavFlightOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IgnavFlightMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IgnavFlightSpec(['step' => 's']),
            'result' => new IgnavFlightResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IgnavFlightOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IgnavFlightMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IgnavFlightResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IgnavFlightSpec([]),
            'result' => new IgnavFlightResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IgnavFlightMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IgnavFlightMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IgnavFlightError('boom', 'boom');
        $utility->fetcher = function (IgnavFlightContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IgnavFlightSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IgnavFlightMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IgnavFlightContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IgnavFlightMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IgnavFlightResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IgnavFlightMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IgnavFlightContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IgnavFlightSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IgnavFlightMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IgnavFlightResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IgnavFlightSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IgnavFlightMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IgnavFlightMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IgnavFlightMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IgnavFlightResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IgnavFlightDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IgnavFlightResult(['ok' => false])]);
        $this->expectException(IgnavFlightError::class);
        IgnavFlightDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IgnavFlightResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IgnavFlightMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IgnavFlightMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IgnavFlightBaseFeature();
        $b = new IgnavFlightBaseFeature();
        IgnavFlightFeatureAdd::call($ctx, $a);
        IgnavFlightFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IgnavFlightBaseFeature
    {
        $f = new IgnavFlightBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IgnavFlightFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IgnavFlightContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IgnavFlightSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IgnavFlightPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IgnavFlightPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IgnavFlightResponse(['headers' => null]),
            'result' => new IgnavFlightResult([]),
        ]);
        IgnavFlightResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IgnavFlightResultBody::call($ctx);

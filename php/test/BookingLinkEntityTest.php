...
class BookingLinkEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IGNAVFLIGHT_TEST_BOOKING_LINK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function booking_link_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IGNAVFLIGHT_TEST_BOOKING_LINK_ENTID");

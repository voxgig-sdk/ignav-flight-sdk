...
// IgnavFlight SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IgnavFlightOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IgnavFlightOmni::structfix($now, Struct::undef()))
                        !== json_encode(IgnavFlightOmni::structfix($val, Struct::undef()))) {

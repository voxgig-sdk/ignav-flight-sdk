...
// IgnavFlight SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IgnavFlightSDK::test)
...
{
    private const SDK_CLASS = 'IgnavFlightSDK';
    ...
    private const SDK_BASE = 'ignavflight_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ignavflight_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

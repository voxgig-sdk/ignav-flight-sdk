...
// IgnavFlight SDK FareSearchModel entity
...
class FareSearchModelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FareSearchModelEntity($this->_client, $opts);
    }

    /**
     * @param FareSearchModel|array $args FareSearchModel data (assoc-array) to store.
     */
    ...
    /**
     * @return FareSearchModel|array The current FareSearchModel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FareSearchModel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FareSearchModel fields).
     */
    ...
    /**
     * Create a new FareSearchModel.
     *
     * @param FareSearchModelCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FareSearchModelCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FareSearchModel|array The created FareSearchModel as an assoc-array at the

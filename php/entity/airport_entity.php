...
// IgnavFlight SDK Airport entity
...
class AirportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AirportEntity($this->_client, $opts);
    }

    /**
     * @param Airport|array $args Airport data (assoc-array) to store.
     */
    ...
    /**
     * @return Airport|array The current Airport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Airport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Airport fields).
     */
    ...
    /**
     * List Airport items matching the given filter.
     *
     * @param AirportListMatch|array|null $reqmatch Match filter (any subset
     *   of Airport fields) as an assoc-array; AirportListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Airport[]|array A list of Airport items as assoc-arrays at
     *   the SDK boundary; throws IgnavFlightError on failure (item-5 convention).
     */

...
// IgnavFlight SDK BookingLink entity
...
class BookingLinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BookingLinkEntity($this->_client, $opts);
    }

    /**
     * @param BookingLink|array $args BookingLink data (assoc-array) to store.
     */
    ...
    /**
     * @return BookingLink|array The current BookingLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BookingLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BookingLink fields).
     */
    ...
    /**
     * Create a new BookingLink.
     *
     * @param BookingLinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BookingLinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BookingLink|array The created BookingLink as an assoc-array at the

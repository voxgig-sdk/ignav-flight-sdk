...
class IgnavFlightRbacFeature extends IgnavFlightBaseFeature
{
    ...
    private function _required(IgnavFlightContext $ctx): ?string
    {
    ...
    private function _reject(IgnavFlightContext $ctx, string $required): void
    {
    ...
    private function _track(IgnavFlightContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
// IgnavFlight SDK netsim feature
...
class IgnavFlightNetsimFeature extends IgnavFlightBaseFeature
{
    ...
    private function _simulate(IgnavFlightContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IgnavFlightContext $ctx, array $applied): void
    {
        $client = $this->client;

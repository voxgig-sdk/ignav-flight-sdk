...
// IgnavFlight SDK ratelimit feature
...
class IgnavFlightRatelimitFeature extends IgnavFlightBaseFeature
{
    ...
    private function _acquire(IgnavFlightContext $ctx): void
    {
    ...
    private function _track(IgnavFlightContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

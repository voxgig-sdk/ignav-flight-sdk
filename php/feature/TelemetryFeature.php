...
// IgnavFlight SDK telemetry feature
...
class IgnavFlightTelemetryFeature extends IgnavFlightBaseFeature
{
    ...
    private function _close(IgnavFlightContext $ctx, bool $ok): void
    {

...
// IgnavFlight SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IgnavFlightTestFeature extends IgnavFlightBaseFeature
{
    ...
    public function init(IgnavFlightContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IgnavFlightContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = IgnavFlightParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IgnavFlightContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IgnavFlightContext $ctx, $op, $args): array
    {

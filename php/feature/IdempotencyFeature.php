...
// IgnavFlight SDK idempotency feature
...
class IgnavFlightIdempotencyFeature extends IgnavFlightBaseFeature
{
    ...
    private function _mutating(IgnavFlightContext $ctx): bool
    {

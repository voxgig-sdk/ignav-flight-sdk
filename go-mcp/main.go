// Command IgnavFlight-mcp is an MCP server exposing the IgnavFlight
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IgnavFlight_list  — list records of an entity
//	IgnavFlight_load  — load a single record of an entity
//
